    ...
    <div class="container">
        ...
        <div class="row justify-content-center p-2 m-5">
            <div class="col-8">
                ...
                @enderror
                <div class="p-3 m-sm-2 bg-primary text-white">
                    <center><img src={{ URL::asset("images/teacher-login.png") }} alt="icon"></center><br>
                    <div class="login-form">
                        <form method="POST" action="{{ url("login/instructor/forgot-password") }}">
                            @csrf
                            <h3 class=" text-center">Forgot password:</h3>
                            <div class="form-group">
                                <input type="text" name="email" class="form-control"
                                    placeholder="instructor@example.com" required="required">
                            </div>
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-secondary">Send confirmation link</button>
                            </div>
                        </form>
                    </div>
                </div>
