...
<body>
    <div class="topnav" id="myTopnav">
        <a href="{{ route('logged-instructor')}}" class="active"><img src={{ URL::asset("images/professor.png") }}
                alt="" width="24"></a>
        <a style="pointer-events: none; cursor: default;" href="">Professor Dashboard</a>
