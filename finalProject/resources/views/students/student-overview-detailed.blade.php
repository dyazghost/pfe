    ...
    <div class="row m-sm-2 justify-content-center">
        <form>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="branch" placeholder="{{$student->branch->branch_name}}"
                        disabled>
                </div>
            </div>
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;" rowspan="4">S1</td>
                        ...
                        <tr>
                            <td style="text-align: center; vertical-align: middle;" rowspan="4">S2</td>
                            <td style="text-align: center; vertical-align: middle;">
                            ...
                            <td style="color:green; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s2_grades->get(0)->grade/4 +
                                $s2_grades->get(1)->grade/4 +
                                $s2_grades->get(2)->grade/4 + 
                                $s2_grades->get(3)->grade/4}}</td>
                            @else
                            <td style="color:red; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s2_grades->get(0)->grade/4 +
                                $s2_grades->get(1)->grade/4 +
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;" rowspan="4">S3</td>
                            <td style="text-align: center; vertical-align: middle;">
                            ...
                            <td style="color:green; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s3_grades->get(0)->grade/4 + 
                                $s3_grades->get(1)->grade/4 +
                                $s3_grades->get(2)->grade/4 +
                                $s3_grades->get(3)->grade/4 }}</td>
                            @else
                            <td style="color:red; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s3_grades->get(0)->grade/4 + 
                                $s3_grades->get(1)->grade/4 +
                        ...
                        <tr>
                            <td style="text-align: center; vertical-align: middle;" rowspan="4">S4</td>
                            <td style="text-align: center; vertical-align: middle;">
                            ...
                            <td style="color:green; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s4_grades->get(0)->grade/4 +
                                $s4_grades->get(1)->grade/4 +
                                $s4_grades->get(2)->grade/4 +
                                $s4_grades->get(3)->grade/4 }}</td>
                            @else
                            <td style="color:red; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s4_grades->get(0)->grade/4 +
                                $s4_grades->get(1)->grade/4 +
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;" rowspan="4">S5</td>
                            <td style="text-align: center; vertical-align: middle;">
                            ...
                            <td style="color:green; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s5_grades->get(0)->grade/4 +
                                $s5_grades->get(1)->grade/4 +
                                $s5_grades->get(2)->grade/4 +
                                $s5_grades->get(3)->grade/4 }}</td>
                            @else
                            <td style="color:red; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s5_grades->get(0)->grade/4 +
                                $s5_grades->get(1)->grade/4 +
                        ...
                        <tr>
                            <td style="text-align: center; vertical-align: middle;" rowspan="4">S6</td>
                            <td style="text-align: center; vertical-align: middle;">
                            ...
                            <td style="color:green; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s6_grades->get(0)->grade/4 +
                                $s6_grades->get(1)->grade/4 +
                                $s6_grades->get(2)->grade/4 +
                                $s6_grades->get(3)->grade/4 }}</td>
                            @else
                            <td style="color:red; text-align: center; vertical-align: middle;" rowspan="4">{{ 
                                $s6_grades->get(0)->grade/4 +
                                $s6_grades->get(1)->grade/4 +
