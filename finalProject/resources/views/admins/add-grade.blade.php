...
<div class="container">
    ...
    <div class="row justify-content-center m-sm-4">
        <form method="POST" action={{ $path }}>
            ...
            <div class="form-group row">
                <label for="Branch" class="col-sm-2 col-form-label">Sub branch:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="branch" id="branch"
                        placeholder="{{ $students->sub_branch->sub_branchName }}" readonly>
                </div>
            </div>
            <br>
            <div class="form-group row">
                ...
                <select class="form-control form-control-sm" name="course_id" id="list2" name="courses ">
                    ...
                    @else
                    <option value="{{ $course->id}}" data-tag="{{$course->semester_id}}">{{$course->course_name}}</option>
                    @endif
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group row">
                ...
                @endif
                @error('grade')
                <p class="text-danger">Grade must be between 0 and 20!</p>
                @enderror
