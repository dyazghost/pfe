    ...
    <div class="container">
        ...
        <div class="row justify-content-center p-2 m-5">
            <div class="col-8">
                ...
                @enderror
                <div class="p-3 m-sm-2 bg-secondary text-white">
                    <center><img src={{ URL::asset("images/admin-login.png") }} alt="icon"></center><br>
                    <div class="login-form">
                        <form method="POST" action="{{ url("login/admin/forgot-password") }}">
                            @csrf
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-dark">Send confirmation link</button>
                            </div>
                        </form>
                    </div>
                </div>
